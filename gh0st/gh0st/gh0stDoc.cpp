...
// 缩略图的支持
void Cgh0stDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void Cgh0stDoc::InitializeSearchContent()
{
...
void Cgh0stDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
